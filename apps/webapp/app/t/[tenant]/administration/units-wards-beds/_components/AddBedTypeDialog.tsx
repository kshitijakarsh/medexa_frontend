...
// export type AddBedTypeForm = z.infer<typeof schema>;

// export function AddBedTypeDialog({
//   open,
//   onClose,
//   onSave,
// }: {
//   open: boolean;
//   onClose: () => void;
//   onSave: (values: AddBedTypeForm) => void;
// }) {
//   const form = useForm<AddBedTypeForm>({
...
//   return (
//     <AppDialog open={open} onClose={onClose} title="Add Bed Type" maxWidth="md:max-w-lg">
//       <Form {...form}>
...
export function AddBedTypeDialog({
    ...
    const handleSubmit = (values: AddBedTypeForm) => {
        onSave(values);
        // onClose();
    };
