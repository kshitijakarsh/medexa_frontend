...
//             onClick={item.onClick}
//             // 👇 FIX IS ON THIS LINE 👇
//             className={`text-sm font-medium text-gray-700 rounded-md px-3 py-2 bg-white data-[highlighted]:bg-[#28B469] data-[highlighted]:text-white transition-colors cursor-pointer`}
//           >
//             {item.label}
//           </DropdownMenuItem>
//         ))}
