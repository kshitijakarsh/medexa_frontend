...
// import { useUserStore } from "@/store/useUserStore"; // where auth token is stored
// import { useDoctorVisitsQuery } from "./api";

// export default function EmergencyPatients() {
//     // const authToken = useUserStore((s) => s);
...
//                     ? [...Array(3)].map((_, i) => <EmergencyPatientSkeleton key={i} />)
//                     : items.map((visit) => (
//                         <EmergencyPatientCard key={visit.id} p={visit.patient} />
//                     ))}
//             </div>
//         </DashboardSectionCard>
//     );
    ...
    return (
        <DashboardSectionCard>
            ...
            <div className="flex items-center justify-between mb-4">
                ...
                <ViewAllLink
                    href={buildUrl(ROUTES.DOCTOR_VIEW_ALL, { tab: "emergency" })}
                    disabled={!hasItems}
                />
            </div>
            ...
            <div className="flex gap-4 overflow-x-auto pb-2">
                ...
                {/* Empty State */}
                {!isLoading && !hasItems && (
                    <div className="text-gray-500 py-4 px-2 text-center w-full">
