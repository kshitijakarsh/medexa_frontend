...
import { MedicationForm, PrescriptionItem } from "./types";
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button className="border border-blue-100 rounded-full text-blue-600 flex items-center gap-2 p-0.5">
                            <span className="p-2.5 bg-blue-200 rounded-full"><FileUp className="w-4 h-4" /></span>
                            <span className="pe-3 py-1 ">Send to Pharmacy</span>
                        </button>
                        <button className="border border-blue-100 rounded-full text-blue-600 flex items-center gap-2 p-0.5">
                            <span className="p-2.5 bg-blue-200 rounded-full"><Printer className="w-4 h-4" /></span>
