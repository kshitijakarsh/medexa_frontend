        ...
        <div className="space-y-6 py-4">
              ...
              <table className="w-full">
                <thead className="bg-gray-50 border-b">
                  <tr>
                    ...
                    <th className="text-center text-xs font-medium text-gray-600 px-4 py-3">{phCommonDict.quantity}</th>
          ...
          <div className="border-t pt-4">
            <div className="flex justify-between items-center">
              <span className="text-lg font-semibold">{phCommonDict.totalAmount}</span>
