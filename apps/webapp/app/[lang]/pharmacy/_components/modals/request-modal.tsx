      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="type">{pDict.type}</Label>
              <Select
                value={formData.type}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="priority">{pDict.priority}</Label>
              <Select
          ...
          {/* Notes */}
          <div className="space-y-2">
            <Label htmlFor="notes">{pDict.notes}</Label>
            <Textarea
              id="notes"
          ...
          {(isEditMode || isViewMode) && (
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="pending">{phCommonDict.pending}</SelectItem>
                  <SelectItem value="approved">{phCommonDict.approved}</SelectItem>
                  <SelectItem value="rejected">{phCommonDict.rejected}</SelectItem>
                  <SelectItem value="completed">{phCommonDict.completed}</SelectItem>
                </SelectContent>
              </Select>
            </div>
          )}
                        ...
                        <div className="flex-1">
                          ...
                          {batch && (
                            <div className="text-sm text-gray-600 space-y-1 mt-1">
                              <div>{pDict.medicineId}: {batch.medicine_id}</div>
                              <div className="flex gap-4">
                                <span>{phCommonDict.quantity}: {batch.quantity}</span>
        ...
        <DialogFooter>
          <Button variant="outline" onClick={() => onOpenChange(false)}>
            {isViewMode ? phCommonDict.close : phCommonDict.cancel}
          </Button>
          {!isViewMode && (
            <Button
