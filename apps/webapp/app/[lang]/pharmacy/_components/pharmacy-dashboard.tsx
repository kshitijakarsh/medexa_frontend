        ...
        <Card className="bg-white border-l-4 border-l-blue-500">
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-bold text-blue-600">
              $ {kpis?.totalStockValue?.value || "0.000"}
            </div>
            <div className={`flex items-center mt-1 text-xs ${kpis?.totalStockValue?.trend === "up" ? "text-green-600" : "text-red-600"}`}>
              ...
              <span>
                {Math.abs(kpis?.totalStockValue?.growthPercentage || 0)}% {kpis?.totalStockValue?.trend === "up" ? pDict.kpis.trends.increase : pDict.kpis.trends.decrease} {pDict.kpis.trends.vsLastMonth}
              </span>
            </div>
          </CardContent>
        </Card>
