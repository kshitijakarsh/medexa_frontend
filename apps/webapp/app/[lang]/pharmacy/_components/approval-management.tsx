...
export function ApprovalManagement() {
  ...
  const getStatusBadge = (status: string) => {
    const statusConfig: Record<string, { className: string; label: string }> = {
      pending: { className: "bg-yellow-100 text-yellow-700 hover:bg-yellow-100", label: commonDict.pending },
      approved: { className: "bg-green-100 text-green-700 hover:bg-green-100", label: commonDict.approved },
      rejected: { className: "bg-red-100 text-red-700 hover:bg-red-100", label: commonDict.rejected },
      completed: { className: "bg-blue-100 text-blue-700 hover:bg-blue-100", label: commonDict.completed },
    }
  ...
  const columns = [
    ...
    {
      key: "priority",
      label: commonDict.priority,
      render: (row: Request) => getPriorityBadge(row.priority),
    },
    {
      key: "status",
      label: commonDict.status,
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4 flex items-start gap-3">
            ...
            <div>
              <div className="text-sm text-gray-600">{commonDict.pending}</div>
        ...
        <Card>
          <CardContent className="p-4 flex items-start gap-3">
            ...
            <div>
              <div className="text-sm text-gray-600">{commonDict.approved}</div>
        ...
        <Card>
          <CardContent className="p-4 flex items-start gap-3">
            ...
            <div>
              <div className="text-sm text-gray-600">{commonDict.rejected}</div>
