...
//         try {
//             return await axios.get<DepartmentListResponse>(
//                 `${this.baseUrl}/api/v1/departments`,
//                 {
...
//         try {
//             return await axios.get<DepartmentDetailResponse>(
//                 `${this.baseUrl}/api/v1/departments/${id}`,
//                 this.getJsonRequestConfig()
//             );
//         } catch (error) {
//             if (axios.isAxiosError(error)) {
