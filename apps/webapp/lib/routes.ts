...
export const ROUTES = {
  ORGANIZATION: `${ADMINISTRATION_BASE}/organization-setup`,
  ...
  ADMINISTRATION_PROFILE: `${ADMINISTRATION_BASE}/profile`,
  ...
  FRONTOFFICE_APPOINTMENT: `${FRONTOFFICE_BASE}/appointment`,
  FRONTOFFICE_APPOINTMENT_BOOK: `${FRONTOFFICE_BASE}/appointment/book`,
